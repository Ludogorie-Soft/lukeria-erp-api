...
public class CartonController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CartonDTO> getCartonById(@PathVariable(name = "id") Long id) throws Exception{ //, @RequestHeader("Authorization") String auth) throws ChangeSetPersister.NotFoundException {
