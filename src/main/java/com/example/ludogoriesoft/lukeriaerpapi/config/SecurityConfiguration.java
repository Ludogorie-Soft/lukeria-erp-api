...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/manufactured-product").hasAnyRole(PRODUCTION_MANAGER.name(), ADMIN.name(),TRANSPORT_MANAGER.name(), CUSTOMER.name())
                .requestMatchers(HttpMethod.POST, "/api/v1/manufactured-product").hasAnyRole(PRODUCTION_MANAGER.name(), ADMIN.name(),TRANSPORT_MANAGER.name(), CUSTOMER.name())
                .requestMatchers(HttpMethod.DELETE, "/api/v1/manufactured-product").hasAnyRole(PRODUCTION_MANAGER.name(), ADMIN.name(),TRANSPORT_MANAGER.name(), CUSTOMER.name())
                .requestMatchers(HttpMethod.PUT, "/api/v1/manufactured-product").hasAnyRole(PRODUCTION_MANAGER.name(), ADMIN.name(),TRANSPORT_MANAGER.name(), CUSTOMER.name())
...
//                 .requestMatchers(CLIENT_USER_URL).hasAnyRole(ADMIN.name())
                ...
                .requestMatchers(HttpMethod.POST,"/api/v1/order/create").hasAnyRole(CUSTOMER.name())
