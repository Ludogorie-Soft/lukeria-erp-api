...
//TODO: fix this service tests and add more
...
//        user1.setUsernameField("User 1");
//
//        User user2 = new User();
//        user2.setId(2L);
//        user2.setFirstname("user2");
//        user2.setUsernameField("User 2");
//
...
//        userDTO1.setId(1L);
//        userDTO1.setUsernameField("user1");
//        userDTO1.setFullName("User 1");
//
//        UserDTO userDTO2 = new UserDTO();
//        userDTO2.setId(2L);
//        userDTO2.setUsernameField("user2");
...
//        assertEquals(mockUsers.get(0).getFirstname(), result.get(0).getFullName());
//        assertEquals(mockUsers.get(1).getUsername(), result.get(1).getUsername());
//        assertEquals(mockUsers.get(1).getFirstname(), result.get(1).getFullName());
//    }
//
//    @Test
...
//        User user = new User();
//        user.setId(userId);
//        user.setUsernameField("user1");
//        user.setFirstname("User 1");
//
//        UserDTO userDTO = new UserDTO();
//        userDTO.setId(userId);
//        userDTO.setUsernameField("user1");
...
//        assertEquals(user.getFirstname(), result.getFullName());
...
//
//        UserDTO userDTO = new UserDTO();
//        userDTO.setUsernameField(""); // Празно потребителско име
//
//        when(userRepository.findByIdAndDeletedFalse(userId)).thenReturn(Optional.of(existingUser));
//
//        // Act and Assert
...
//        // Arrange
//        User user = new User();
//        user.setUsernameField(""); // Празно потребителско име
//        user.setFullName("User 1");
//        user.setEmail("user1@example.com");
//        user.setPassword("password");
//        user.setRole(Role.ADMIN);
...
//
//        User user = new User();
//        user.setUsernameField("abc"); // Подаваме потребителско име с по-малка дължина от 4 символа
//
...
//        // Arrange
//        User user = new User();
//        user.setUsernameField("User 1"); // Празно потребителско име
//        user.setFullName("");
//        user.setEmail("user1@example.com");
//        user.setPassword("password");
//        user.setRole(Role.ADMIN);
